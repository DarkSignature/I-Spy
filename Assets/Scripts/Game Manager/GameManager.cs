...
public class GameManager : MonoBehaviourPunCallbacks
{
    ...
    private void Awake()
    {
        ...
        // Debug.Log($"Loaded {animalPrefabs.Length} animal prefabs");
    }
    ...
    {
        Debug.Log(question == null ? "Question is NULL" : question.questionText);
        DespawnAnimals();
        ...
        foreach (GameObject prefab in animalPrefabs)
        {
            ...
            Debug.Log($"{prefab.name} -> Animal component: {(animal != null)}");
            if (animal == null)
            {
